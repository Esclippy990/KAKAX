...
const server = http.createServer((req, res) => {
  ...
  <body>
  <span style="position: fixed; font-family: sans-serif; user-select: none; transition: 0.5s; opacity: 1; transform: translate(-50%, -50%) scale(1.5); text-align: center; top: 50%; left: 50%;" id="intro"><b style="font-size: 30px;">Chat room - ${String(
    Math.floor(view / 2)
  ...
  <div id="chat" style="overflow-wrap: break-word;">
